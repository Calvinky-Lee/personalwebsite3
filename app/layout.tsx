    ...
    <html lang="en">
      <body className="antialiased min-h-screen flex flex-col items-center" suppressHydrationWarning>
        ...
        <header className="fixed top-0 left-0 right-0 h-16 w-full z-50 bg-[#f3f4f6]/90 backdrop-blur-md border-b border-black/[0.03] animate-slide-in-top">
          <div className="w-full h-full flex justify-between items-center" style={{ paddingLeft: '32px', paddingRight: '32px' }}>
          {/* CS Webring Nav - Prev / Ring / Next */}
          <div className="webring-nav flex items-center text-sm font-medium font-sans" style={{ gap: '4px' }}>
          ...
          <div className="flex items-center text-sm font-medium font-sans">
            ...
            {/* Social Icons Group */}
            <div className="flex items-center gap-4 md:gap-6 pr-1 md:pr-0">
            ...
            <a href="/resume.pdf" target="_blank" className="opacity-80 hover:opacity-100 transition-opacity ml-2 md:ml-4">
              resume
            </a>
        ...
        <div className="flex-grow w-full" style={{ paddingTop: '90px', paddingBottom: '60px' }}>
          {children}
        </div>
